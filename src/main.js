const addEvents = () => {
    let data = [
        ...
        {
            "id": 4,
            "imgs": ["Mi música_1.jpg", "Mi música_2.jpg"],
            "nombre": "Mi música",
        ...
        {
            "id": 9,
            "imgs": ["Retrato a lápiz de color_1.jpg", "Retrato a lápiz de color_2.jpg"],
        ...
        {
            "id": 10,
            "imgs": ["Retrato a bolígrafo_1.jpg", "Retrato a bolígrafo_2.jpg"],
        ...
        {
            "id": 12,
            "imgs": ["Fotografías de arquitectura_1.JPG", "Fotografías de arquitectura_2.JPG", "Fotografías de arquitectura_3.JPG", "Fotografías de arquitectura_4.JPG"],
        ...
        {
            "id": 13,
            "imgs": ["Rever Diseño web_1.jpg", "Rever Diseño web_2.jpg", "Rever Diseño web_3.jpg"],
        ...
        {
            "id": 16,
            "imgs": ["Rever Cartel de actuación_1.jpg", "Rever Cartel de actuación_2.jpg"],
        ...
        {
            "id": 17,
            "imgs": ["Día de las Personas con Discapacidad_1.jpg", "Día de las Personas con Discapacidad_2.jpg"],
        ...
        data.forEach(elem => {
            ...
            html += `
                <li class="trabajo" id="${elem.id}">
                    <div class="card">
                        <a class="enlace" href="">
                            <img src="assets/img/${elem.nombre}_1.jpg" alt="${elem.nombre}" class="imgproy">
